                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="relative mx-auto <?php echo e($materialEffects); ?>"
                                            ...
                                            <div class="w-full h-full bg-gradient-to-br <?php echo e($materialColor); ?> border-8 <?php echo e($shapeClass); ?> flex items-center justify-center relative overflow-hidden"
                                                ...
                                                <?php if(str_contains($materialSlug, 'foil') ||
                                                        str_contains($materialSlug, 'glossy') ||
                                                ...
                                                <?php if(str_contains($materialSlug, 'gold') ||
                                            ...
                                            <?php if($project->laminateOption): ?>
                                                <div
                                                    class="absolute inset-0 <?php echo e($shapeClass); ?> border-6 border-blue-500 bg-gradient-to-br from-blue-200 to-transparent opacity-60 pointer-events-none">
                                        ...
                                        <div class="mt-20 text-lg text-gray-600 space-y-4">
                                            <div class="font-bold text-gray-900 text-3xl">
                                                <?php echo e($project->labelShape->name); ?></div>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6">
                    ...
                    <div class="space-y-3 text-sm">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span
                                class="font-medium"><?php echo e($project->getActualDimensions()['width']); ?>×<?php echo e($project->getActualDimensions()['height']); ?>mm</span>
                        </div>
                        <?php if($project->laminateOption): ?>
                            <div class="flex justify-between">
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            ...
            function goBackToCreator() {
                ...
                window.location.href =
                    '<?php echo e(route('home')); ?>?project=<?php echo e($project->id); ?>&step=4&fromPreview=true&returnToCreator=true#label-creator';
            }
            ...
            const projectConfig = {
                ...
                laminateType: '<?php echo e($project->laminateOption->slug ?? ''); ?>',
