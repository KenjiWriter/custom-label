...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Custom Labels - '.e(__('messages.home.hero.subtitle')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Custom Labels - '.e(__('messages.home.hero.subtitle')).'']); ?>
    ...
    <div
        ...
        <div class="max-w-5xl mx-auto text-center text-white relative z-10">
            ...
            <h1 class="text-4xl md:text-6xl font-bold mb-8 leading-tight drop-shadow-lg">
                <?php echo e(__('messages.home.hero.title')); ?>

            </h1>
            <p class="text-xl md:text-2xl mb-12 max-w-2xl mx-auto font-light">
                <?php echo e(__('messages.home.hero.description')); ?>
            ...
            <div class="flex flex-wrap justify-center gap-6 mb-14">
                <a href="#label-creator"
                    ...
                    <?php echo e(__('messages.home.hero.cta_button')); ?>
                ...
                <a href="#"
                    ...
                    <?php echo e(__('messages.home.hero.expert_button')); ?>
            ...
            <div class="flex justify-center gap-8 mt-6 text-sm opacity-90">
                <div
                    ...
                    <?php echo e(__('messages.home.hero.features.free_templates')); ?>
                ...
                <div
                    ...
                    <?php echo e(__('messages.home.hero.features.support_24_7')); ?>
                ...
                <div
                    ...
                    <?php echo e(__('messages.home.hero.features.guarantee')); ?>
        ...
        <div class="max-w-6xl mx-auto relative z-10">
            <div class="text-center mb-14">
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-5">
                    <?php echo e(__('messages.home.creator.title')); ?>

                </h2>

                <p class="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
                    <?php echo e(__('messages.home.creator.subtitle')); ?>

                    <span class="block mt-2 text-orange-500 font-medium"><?php echo e(__('messages.home.creator.start_below')); ?></span>
                </p>
            </div>
                ...
                <div class="mt-10 pt-6 border-t border-gray-100">
                    <div class="flex flex-wrap justify-center gap-6 text-sm text-gray-500">
                        <div class="flex items-center">
                            ...
                            <?php echo e(__('messages.home.creator.features.secure_payments')); ?>
                        ...
                        <div class="flex items-center">
                            ...
                            <?php echo e(__('messages.home.creator.features.satisfaction_guarantee')); ?>
                        ...
                        <div class="flex items-center">
                            ...
                            <?php echo e(__('messages.home.creator.features.fast_delivery')); ?>
                        ...
                        <div class="flex items-center">
                            ...
                            <?php echo e(__('messages.home.creator.features.support_24_7')); ?>
            ...
            <div class="py-16 px-4 bg-gray-50">
                <div class="max-w-6xl mx-auto" id="gotowe-konfiguracje">
                    <div class="text-center mb-16">
                        ...
                        <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4"><?php echo e(__('messages.home.templates.title')); ?></h2>
                        <p class="text-gray-600 text-lg max-w-3xl mx-auto"><?php echo e(__('messages.home.templates.subtitle')); ?></p>
                    </div>
                    ...
                    <div class="text-center mt-14">
                        <p class="text-gray-600 text-sm"><?php echo e(__('messages.home.templates.click_to_setup')); ?></p>
                    </div>
                </div>
            </div>
                ...
                <div class="max-w-6xl mx-auto relative z-10">
                    <div class="text-center mb-16">
                        <span
                            ...
                            My?</span>
                        <h2 class="text-4xl font-bold text-gray-900 mt-4 mb-3"><?php echo e(__('messages.home.why_choose.title')); ?></h2>
                        <p class="text-gray-600 text-lg max-w-3xl mx-auto"><?php echo e(__('messages.home.why_choose.subtitle')); ?></p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                        ...
                        <div
                            ...
                            <h3 class="font-bold text-2xl text-gray-800 mb-4"><?php echo e(__('messages.home.why_choose.features.ai_design.title')); ?></h3>
                            <p class="text-gray-600 mb-6 leading-relaxed"><?php echo e(__('messages.home.why_choose.features.ai_design.description')); ?></p>
                            <a href="#"
                                class="text-orange-500 hover:text-orange-600 inline-flex items-center font-medium group-hover:underline">
                                <?php echo e(__('messages.home.why_choose.features.ai_design.link')); ?>
                        ...
                        <div
                            ...
                            <h3 class="font-bold text-xl text-gray-800 mb-3"><?php echo e(__('messages.home.why_choose.features.personalization.title')); ?></h3>
                            <p class="text-gray-600 mb-4"><?php echo e(__('messages.home.why_choose.features.personalization.description')); ?></p>
                            <a href="#"
                                class="nav-link text-orange-500 hover:text-orange-600 inline-flex items-center font-medium">
                                <?php echo e(__('messages.home.why_choose.features.personalization.link')); ?>
                        ...
                        <div
                            ...
                            <h3 class="font-bold text-xl text-gray-800 mb-3"><?php echo e(__('messages.home.why_choose.features.fast_delivery.title')); ?></h3>
                            <p class="text-gray-600 mb-4"><?php echo e(__('messages.home.why_choose.features.fast_delivery.description')); ?></p>
                            <a href="#"
                                class="nav-link text-orange-500 hover:text-orange-600 inline-flex items-center font-medium">
                                <?php echo e(__('messages.home.why_choose.features.fast_delivery.link')); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
                        ...
                        <div
                            ...
                            <h3 class="font-bold text-xl text-gray-800 mb-3"><?php echo e(__('messages.home.why_choose.features.quality.title')); ?></h3>
                            <p class="text-gray-600 mb-4"><?php echo e(__('messages.home.why_choose.features.quality.description')); ?></p>
                            <a href="#"
                                class="nav-link text-orange-500 hover:text-orange-600 inline-flex items-center font-medium">
                                <?php echo e(__('messages.home.why_choose.features.quality.link')); ?>
                        ...
                        <div
                            ...
                            <h3 class="font-bold text-xl text-gray-800 mb-3"><?php echo e(__('messages.home.why_choose.features.expert_support.title')); ?></h3>
                            <p class="text-gray-600 mb-4"><?php echo e(__('messages.home.why_choose.features.expert_support.description')); ?></p>
                            <a href="#"
                                class="nav-link text-orange-500 hover:text-orange-600 inline-flex items-center font-medium">
                                <?php echo e(__('messages.home.why_choose.features.expert_support.link')); ?>
                        ...
                        <div
                            ...
                            <h3 class="font-bold text-xl text-gray-800 mb-3"><?php echo e(__('messages.home.why_choose.features.business_analytics.title')); ?></h3>
                            <p class="text-gray-600 mb-4"><?php echo e(__('messages.home.why_choose.features.business_analytics.description')); ?></p>
                            <a href="#"
                                class="nav-link text-orange-500 hover:text-orange-600 inline-flex items-center font-medium">
                                <?php echo e(__('messages.home.why_choose.features.business_analytics.link')); ?>
            ...
            <div class="py-24 px-4 bg-gray-50 relative" id="pricing">
                ...
                <div class="max-w-5xl mx-auto relative z-10">
                    <div class="text-center mb-12">
                        ...
                        <h2 class="text-3xl font-bold text-gray-900 mt-4 mb-2"><?php echo e(__('messages.home.pricing.title')); ?></h2>
                        <p class="text-gray-600 text-lg"><?php echo e(__('messages.home.pricing.subtitle')); ?></p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div
                            ...
                            <div class="p-6 text-center">
                                ...
                                <h3 class="text-lg font-bold text-gray-800 mb-1"><?php echo e(__('messages.home.pricing.packages.starter.name')); ?></h3>
                                <p class="text-sm text-gray-500 mb-4"><?php echo e(__('messages.home.pricing.packages.starter.description')); ?></p>

                                <div class="mb-6 price-counter">
                                    <span class="text-4xl font-bold text-gray-900"
                                        data-target-price="0.25"><?php echo e(__('messages.home.pricing.packages.starter.price')); ?></span>
                                    <span class="text-sm text-gray-500"><?php echo e(__('messages.home.pricing.packages.starter.period')); ?></span>
                                </div>
                                ...
                                <ul class="text-left space-y-3 mb-8">
                                    <li class="flex items-center text-sm">
                                        ...
                                        <?php echo e(__('messages.home.pricing.packages.starter.features.0')); ?>
                                    ...
                                    <li class="flex items-center text-sm">
                                        ...
                                        <?php echo e(__('messages.home.pricing.packages.starter.features.1')); ?>
                                    ...
                                    <li class="flex items-center text-sm">
                                        ...
                                        <?php echo e(__('messages.home.pricing.packages.starter.features.2')); ?>
                                    ...
                                    <li class="flex items-center text-sm">
                                        ...
                                        <?php echo e(__('messages.home.pricing.packages.starter.features.3')); ?>
                                ...
                                <button
                                    ...
                                    <?php echo e(__('messages.home.pricing.packages.starter.button')); ?>
...
class="bg-white rounded-xl shadow-lg border border-orange-600 overflow-hidden transform transition duration-300 hover:shadow-xl hover:scale-105"                            <!-- Badge with animation -->
                            ...
                            <div class="p-8 text-center">
                                ...
                                <h3 class="text-lg font-bold text-gray-800 mb-1"><?php echo e(__('messages.home.pricing.packages.professional.name')); ?></h3>
                                <p class="text-sm text-gray-500 mb-4"><?php echo e(__('messages.home.pricing.packages.professional.description')); ?></p>

                                <div class="mb-6 price-counter">
                                    <span class="text-4xl font-bold text-orange-500"
                                        data-target-price="0.18">$0.18</span>
                                    <span class="text-sm text-gray-500"><?php echo e(__('messages.home.pricing.packages.professional.period')); ?></span>
                                </div>
                                ...
                                <ul class="text-left space-y-3 mb-8">
                                    <li class="flex items-center text-sm">
                                        ...
                                        <?php echo e(__('messages.home.pricing.packages.professional.features.0')); ?>
                                    ...
                                    <li class="flex items-center text-sm">
                                        ...
                                        <?php echo e(__('messages.home.pricing.packages.professional.features.1')); ?>
                                    ...
                                    <li class="flex items-center text-sm">
                                        ...
                                        <?php echo e(__('messages.home.pricing.packages.professional.features.2')); ?>
                                    ...
                                    <li class="flex items-center text-sm">
                                        ...
                                        <?php echo e(__('messages.home.pricing.packages.professional.features.3')); ?>
                                    ...
                                    <li class="flex items-center text-sm">
                                        ...
                                        <?php echo e(__('messages.home.pricing.packages.professional.features.4')); ?>
                                ...
                                <button
                                    ...
                                    <?php echo e(__('messages.home.pricing.packages.professional.button')); ?>
                        ...
                        <div
                            ...
                            <div class="p-6 text-center">
                                ...
                                <h3 class="text-lg font-bold text-gray-800 mb-1"><?php echo e(__('messages.home.pricing.packages.enterprise.name')); ?></h3>
                                <p class="text-sm text-gray-500 mb-4"><?php echo e(__('messages.home.pricing.packages.enterprise.description')); ?></p>
    ...
    <div class="h-1 bg-gradient-to-r from-transparent via-orange-200 to-transparent my-8"></div>
                ...
                <div class="max-w-5xl mx-auto">
                    <div class="text-center mb-12">
                        <span class="bg-yellow-100 text-yellow-600 text-sm font-medium px-4 py-2 rounded-full">Opinie
                            klientów</span>
                        <h2 class="text-3xl font-bold text-gray-900 mt-4 mb-2"><?php echo e(__('messages.home.testimonials.title')); ?></h2>
                        <p class="text-gray-600 text-lg"><?php echo e(__('messages.home.testimonials.subtitle')); ?></p>
                    </div>
            ...
            <div
                ...
                <div class="max-w-5xl mx-auto text-center relative z-10">
                    <h2 class="text-4xl font-bold text-white mb-8 drop-shadow-lg"><?php echo e(__('messages.home.cta.title')); ?></h2>

                    <p class="text-xl text-white/90 mb-12 max-w-2xl mx-auto leading-relaxed">
                        <?php echo e(__('messages.home.cta.subtitle')); ?>
            ...
            <div class="py-24 px-4 bg-gray-50" id="faq">
                <div class="max-w-4xl mx-auto">
                    <div class="text-center mb-16">
                        ...
                        <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4"><?php echo e(__('messages.home.faq.title')); ?></h2>
                        <p class="text-gray-600 text-lg"><?php echo e(__('messages.home.faq.subtitle')); ?></p>
                    </div>
