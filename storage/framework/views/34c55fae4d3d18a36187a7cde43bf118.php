<div>
    ...
    <div class="auth-tabs">
        ...
        <a href="<?php echo e(route('register')); ?>" wire:navigate class="auth-tab">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
...
<?php /**PATH C:\xampp\htdocs\custom-label\resources\views/livewire/auth/login.blade.php ENDPATH**/ ?>