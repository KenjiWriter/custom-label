        ...
        <form class="space-y-8">
            ...
            <div x-show="currentStep === 1"
                ...
                <div class="flex justify-center">
                    <button
                        type="button"
                        class="px-8 py-3 font-semibold rounded-xl transition-all duration-200 <?php echo e($selectedShape ? 'bg-orange-600 text-white shadow-lg hover:bg-orange-700' : 'bg-gray-300 text-gray-600 cursor-not-allowed'); ?>"
                        @click="nextStep()"
                        :disabled="!<?php echo e($selectedShape ? 'true' : 'false'); ?>"
                    >
                        Dalej
                    </button>
                </div>
...
<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="flex justify-between">
                    ...
                    <button
                        ...
                        @click="nextStep()"
                        :disabled="!<?php echo e($selectedMaterial ? 'true' : 'false'); ?>"
                    >
                        Dalej
                    </button>
                </div>
...
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-1 text-red-600 text-sm"><?php echo e($message); ?></p> <?php unset($message);
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $availableSizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="relative cursor-pointer">
                                    ...
                                    <div class="p-4 border-2 rounded-xl transition-all duration-200 bg-white shadow-sm hover:shadow-md peer-checked:border-orange-600 peer-checked:shadow-lg peer-checked:bg-orange-50 h-full">
                                        ...
                                        <div class="text-sm text-gray-500 mb-2"><?php echo e($size->width_mm); ?> × <?php echo e($size->height_mm); ?> mm</div>

                                        <div class="relative h-20 bg-gray-100 rounded-lg overflow-hidden">
                                            <div class="absolute inset-0 flex items-center justify-center">
                                                <div style="width: <?php echo e(min(80, $size->width_mm / 2)); ?>px; height: <?php echo e(min(60, $size->height_mm / 2)); ?>px;" class="bg-orange-300 rounded shadow-sm"></div>
                                            </div>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="flex justify-between">
                    ...
                    <button
                        ...
                        @click="nextStep()"
                        :disabled="!(<?php echo e(($useCustomSize && $customWidth && $customHeight) || (!$useCustomSize && $selectedSize) ? 'true' : 'false'); ?>)"
                    >
                        Dalej
                    </button>
                </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <div class="flex items-center">
                                    <button type="button" wire:click="$set('quantity', Math.max(1, <?php echo e($quantity); ?> - 10))" class="p-2 rounded-l-lg bg-orange-100 text-orange-600 border border-r-0 border-orange-200 hover:bg-orange-200 transition-colors">
                                    ...
                                    <button type="button" wire:click="$set('quantity', <?php echo e($quantity); ?> + 10)" class="p-2 rounded-r-lg bg-orange-100 text-orange-600 border border-l-0 border-orange-200 hover:bg-orange-200 transition-colors">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        >
            ...
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-200 text-center">
                        ...
                        <div class="text-3xl font-bold text-orange-600 mb-1"><?php echo e(number_format($calculatedPrice, 2)); ?> zł</div>
