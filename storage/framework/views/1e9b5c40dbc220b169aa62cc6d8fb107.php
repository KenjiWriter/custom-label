                                ...
                                <div class="ml-3">
                                    <div class="text-sm font-medium transition-colors"
                                        :class="currentStep >= step ? 'text-orange-600 border-b-2 border-orange-600 pb-1' :
                                            'text-gray-500'">
                                        <span x-show="step === 1"><?php echo e(__('messages.home.creator.steps.choose_shape')); ?></span>
                                        <span x-show="step === 2"><?php echo e(__('messages.home.creator.steps.choose_material')); ?></span>
                                        <span x-show="step === 3"><?php echo e(__('messages.home.creator.steps.choose_size')); ?></span>
                                        <span x-show="step === 4"><?php echo e(__('messages.home.creator.steps.finalization')); ?></span>
                                    </div>
                                </div>
                            </div>
        ...
        <form class="space-y-8">
            ...
            <div x-show="currentStep === 1"
                ...
                <div class="text-center">
                    <h3 class="text-2xl font-bold text-gray-900 mb-4"><?php echo e(__('messages.home.creator.shape_section.title')); ?></h3>
                    <p class="text-gray-600 max-w-2xl mx-auto">
                        <?php echo e(__('messages.home.creator.shape_section.description')); ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $shapes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shape): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="relative cursor-pointer">
                            ...
                            <div
                                ...
                                <span class="font-medium text-gray-900 text-sm"><?php echo e($shape->translated_name); ?></span>
                                <p class="mt-1 text-xs text-gray-500"><?php echo e(Str::limit($shape->translated_description, 60)); ?></p>
                            </div>
                        </label>
                ...
                <div class="flex justify-center">
                    <button type="button"
                        ...
                        <?php echo e(__('messages.home.creator.shape_section.next_button')); ?>
