                    ...
                    <div class="bg-gray-50 rounded-xl p-6">
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            <div class="text-center py-8">
                                ...
                                <h4 class="font-semibold text-gray-900 mb-2">Brak danych produktu</h4>
                                <p class="text-sm text-gray-600 mb-4">Nie udało się załadować szczegółów produktu.</p>
                                <div class="text-xs text-gray-500">
                                    <p>Debug info:</p>
                                    <p>Project ID: {{ session('project_id') ?? 'brak' }}</p>
                                    <p>Project: {{ $project ? 'znaleziony' : 'null' }}</p>
                                </div>
                            </div>
                        </div>
                        @endif
