                        ...
                        <div class="border-t pt-4">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <input type="number" id="quantity-input" value="{{ $project->quantity ?? 1 }}" min="1" max="10000" 
                ...
                modal.innerHTML = `
                    <div class="bg-white rounded-2xl p-8 max-w-md mx-auto text-center animate-pop">
                        ...
                        <div class="space-y-3">
                            ...
                            <button onclick="window.location.href='{{ route('home') }}'" class="w-full bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold px-6 py-3 rounded-lg transition-colors">
